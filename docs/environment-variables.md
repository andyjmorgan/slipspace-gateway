...
| `SLUICE_OTEL_CAPTURE_CONTENT` | `false` | bool | Emit bounded, redacted prompt/response content on the GenAI span + operation-details event. Default off. |
