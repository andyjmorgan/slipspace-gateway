...
The canonical Go types are in [`contracts/config/model.go`](../contracts/config/model.go) — `Provider` (lines 50–81), `ProviderProtocol` (84–96), `ProviderAuth` (101–110), `PassthroughFamily` (118–127) / `PassthroughPath` (130–142). What follows is the operator-facing summary.
