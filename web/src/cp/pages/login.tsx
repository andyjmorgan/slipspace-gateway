...
export function LoginPage() {
  ...
  const from = (loc.state as { from?: string } | null)?.from ?? "/fleet"
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      auth.clear()
      setError("Could not reach the control plane. Check that the API listener is up.")
      setBusy(false)
    }
  }
