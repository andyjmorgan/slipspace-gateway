...
// ErrDuplicateKey is returned by LoadV2 when a top-level block (backends,
...
// ErrV2Validation is the umbrella sentinel for v2 config validation failures
...
var ErrV2Validation = errors.New("config: v2 validation")
