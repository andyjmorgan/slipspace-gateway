...
// spaFS holds the Vite build output for the Arbiter console. Production builds
// expect internal/arbiter/server/webdist/ to contain a freshly-built SPA (see
...
// spaHandler serves the embedded Arbiter console SPA. Real assets (hashed
