...
func TestResolveTemplate(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "state protocol ref", tmpl: "{state.protocol}", refs: Refs{Protocol: "chat"}, want: `"chat"`},
		{name: "state provider miss drops", tmpl: "{state.provider}", drop: true},
		{name: "state protocol miss drops", tmpl: "{state.protocol}", drop: true},
		...
		{name: "mixed state protocol", tmpl: "e-{state.protocol}", refs: Refs{Protocol: "chat"}, want: `"e-chat"`},
