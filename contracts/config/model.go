...
// a provider or resilience group. Routing rules (changeProvider/changeUrl/
// changeApiKey/useResiliencePolicy) become binding/provider/group data; rules
...
type Provider struct {
	...
	Protocols map[string]ProviderProtocol `yaml:"protocols,omitempty" json:"protocols,omitempty"`
